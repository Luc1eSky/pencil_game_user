        ...
        builder: (context, userSnap) {
          ...
          return StreamBuilder(
              ...
              builder: (context, surveySnap) {
                ...
                Survey survey;
                try {
                  survey = Survey.fromJson(surveySnap.data!.data()!);
                } catch (e) {
                  return Text('Error with survey object: ${e.toString()}');
                }

                // show button with survey link
                if (survey.showSurvey) {
                  return ElevatedButton(
                    onPressed: () async {
                      // final testUrlString =
                      //     'https://usfca.qualtrics.com/jfe/form/SV_ahlbLJ6Axa4XXW6';

                      final linkWithUid = '${survey.surveyLink}?pid=$userUid';
                      final url = Uri.parse(linkWithUid);
                      html.window.open(linkWithUid, '_blank');
                                ...
                                : StreamBuilder(
                                    ...
                                    builder: (context, realtimeSnap) {
                                      ...
                                      try {
                                        ...
                                        return Text('Realtime table object error HERE: $e');
                                      }
